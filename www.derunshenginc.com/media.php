            ...
            <table class="table">
              <thead>
                <tr>
                  ...
                  <th class="text-center" style="width: 20%;">图片类型</th>
                ...
                <td class="text-center">
                  <a href="delete_media.php?id=<?php echo (int) $media_file['id'];?>" class="btn btn-danger btn-xs"  title="删除">
